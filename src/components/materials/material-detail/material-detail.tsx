          ...
          <ion-row no-padding id='materialDetail-row1'>
              ...
              <ion-card color='tertiary'>
                <ion-card-header no-padding color='tertiary'>
                  <ion-toolbar no-padding color='tertiary'>
                    <ion-title slot='start' class='card-header-title'>Status &amp; Location</ion-title>
                  </ion-toolbar>
                </ion-card-header>
                <ion-card-content>
                  <ion-grid no-padding>
                    <ion-row no-padding>
                      <ion-col no-padding sizeLg='6' sizeXs='12'>
            ...
            <ion-col no-padding sizeLg='4' sizeXs='12'>
              ...
              <ion-grid no-padding>
                <ion-row no-padding>
                  <ion-col no-padding size='6'>
                    <ion-card color='tertiary' no-padding>
                      <ion-card-content no-padding>
                        ...
                        <ion-item color='tertiary'>
                          <img src="/assets/images/spool001.png" height={100} alt="thumbnail"/>
                        </ion-item>
                      </ion-card-content>
                    </ion-card>
                  </ion-col>
                  <ion-col no-padding size='6'>
                    <ion-card color='tertiary' no-padding>
                      <ion-card-content no-padding>
                        ...
                        <ion-item color='tertiary'>
                          <img src="/assets/images/map001.png" height={100} alt="thumbnail"/>
                        </ion-item>
                      </ion-card-content>
                    </ion-card>
                  </ion-col>
              ...
              <ion-card color='tertiary'>
                <ion-card-header no-padding color='tertiary'>
                  <ion-toolbar no-padding color='tertiary'>
                    <ion-title slot='start' class='card-header-title'>History</ion-title>
                    <ion-buttons slot='end'>
